...
//Botones editar, eliminar y guardar
...
function muestra(personas) {
    ...
    for (var i = 0; i < personas.length; i++) {
        html += "<tr>";
        html += "<td>" + personas[i].dni + "</td>";
        html += "<td>" + personas[i].nombre + "</td>";
        html += "<td>" + personas[i].apellidos + "</td>";
        html += '<td><button onclick="editarPersona(' + i + ')">Editar</button>' +
                '<button onclick="borrarPersona(' + i + ')">Borrar</button></td>';
        html += "</tr>";
    }
    return html;
}
